...
public class DetailGraph extends Activity{
	WebView mWebView;
	...
	public void DisplayURL(String fileName) {
		...
		mWebView.loadUrl("http://"+ dbserver + "/" + "graphpatient.php?xmloption=N&teamid=" + teamid + "&patient_id=" + patient_id + "&user_name=" + username);
	}
	@Override 
