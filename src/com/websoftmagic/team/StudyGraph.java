...
public class StudyGraph extends Activity{
	WebView mWebView;
	private static final String TAG = "StudyGraph";
	...
	public void DisplayURL(String fileName) {
		...
		mWebView.loadUrl("http://"+ dbserver + "/" + "graphstudy.php?teamid=" + teamid + "&study_id=" + study_id + "&user_name=" + username);
	}
	@Override 
