...
public class StudyAdd extends Activity{
	private static String succeed[] = null;
	private static final String TAG = "Study Add";
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.study_add2);
        EditText edit = (EditText) findViewById(R.id.study_id);
        edit.requestFocus();
	...
	public boolean onCreateOptionsMenu(Menu menu) {
	    getMenuInflater().inflate(R.menu.activity_studyadd, menu);
	    return true;
	}
	...
	public void AddStudyClicked (MenuItem item){
    	...
    	EditText editTextID = (EditText) findViewById(R.id.study_id);
    	String tid = editTextID.getText().toString();
    	if (tid.length() < 1 ) {
    		AlertDialog.Builder alertbox = new AlertDialog.Builder(StudyAdd.this);
    		alertbox.setTitle("Study ID must be at least 1 character").setMessage("Please Correct ID").setNeutralButton("OK", null).show();
    		return;
    	}
    	int pos = tid.indexOf( " " );
    	...
    	if ((pos > -1) || (pos2 > -1)) {
    		AlertDialog.Builder alertbox = new AlertDialog.Builder(StudyAdd.this);
    		alertbox.setTitle("Study ID can not have spaces or special characters").setMessage("Please Correct ID").setNeutralButton("OK", null).show();
    		return;
    	}
    	...
    	if (seatsnc.length() < 1) {
    		AlertDialog.Builder alertbox = new AlertDialog.Builder(StudyAdd.this);
    		alertbox.setTitle("Please enter number of seats in this study").setMessage("Please Correct Number of seats").setNeutralButton("OK", null).show();
    		return;
    	}
		new AddStudy().execute();	
	}
	...
	public void GoToStudies (MenuItem item){
	   ...
	   class AddStudy extends AsyncTask<Object, Object, Object> {
			...
			protected Object doInBackground(Object... paramsx) {
				...
				EditText sid = (EditText) findViewById(R.id.study_id);
		    	String study_id = sid.getText().toString();
				EditText comp = (EditText) findViewById(R.id.company);
		    	String company = comp.getText().toString();
		    	EditText desc = (EditText) findViewById(R.id.description);
		    	String description = desc.getText().toString();
				...
				String URL = "http://" + dbserver + "/teamaddstudy.php?teamid=" 
